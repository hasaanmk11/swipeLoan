  ...
  class GraphCard extends StatelessWidget {
            ...
            SizedBox(
              ...
              child: Stack(
                children: [
                  ...
                  ..._buildValueBadges(labels, labelColors, labelTextColors),
    ...
    // NOTE: precise pixel positions depend on chart size; tweak left offsets
    // to match your exact rendered width if needed.
    List<Widget> _buildValueBadges(
      List<String> labels,
      List<Color> bgColors,
